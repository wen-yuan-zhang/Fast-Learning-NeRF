...
def parse_arguments():
    ...
    group.add_argument('--subdivide_every', type=int, default=2, help='subdivide quadTrees every x epochs')
    group.add_argument('--allPixel_every', type=int, default=5, help='use all pixel rays every x epochs')
    group.add_argument('--subdivide_thres', type=float, default=0.005, help='threshold used in subdividing quadtrees')
    group.add_argument('--init_level', type=int, default=3, help='init quadtree level: 3 means subdivide twice.')
    group.add_argument('--rays_downscale', type=int, default=1, help='downscale rays to match different dataset(llff: 4, lego: 1)')
    group.add_argument('--randSamp_perc', type=float, default=0.3, help='randomly sample percentage of rays instead of prob sampling')
    group.add_argument('--dset_name', type=str, default='lego', help='name of dataset')
    ...
    group.add_argument('--n_epoch', type=int, default=10, help='total number of epochs to optimize for')
