...
class QuadTreeManager:
    ...
    def __init__(self, ray_samplers: List[RaySamplerSingleImage], mseThres=0.1, max_depth=5):
        """
    ...
    def gen_rays_v3_multiThread(self, down_scale=16, prob=True, rand=0.7, debug=False, last_epoch=False):
        """
        gen_rays_v3的多线程版本
        """
        ray_num_per_image = self.epoch_size / self.n_images / down_scale
