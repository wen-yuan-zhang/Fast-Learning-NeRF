...
def config_parser():
    ...
    parser.add_argument("--n_epoch", type=int, default=12, help='number of total epoch')
    parser.add_argument("--init_level", type=int, default=3, help='init quadtree subdivide level, block number is 4^level.')
    ...
    parser.add_argument("--end_rand", type=int, default=11, help='start to add color sampling from this epoch')
